...
\begin{itemize}
    ...
    \item \textbf{Verificación de las macroceldas:} El funcionamiento de las macroceldas, tanto de manera individual como en conjunto debe ser verificado para su fabricación. Se procede entonces a hacer el DRC (Revisión de reglas de diseño), ERC (revisión de reglas eléctricas) y la síntesis de la señal de reloj (CTS). 
     \item \textbf{Preparativos para el tapeout:} Se debe entonces preparar la configuración necesaria para incluir el diseño en una corrida de fabricación de oblea multiproyecto (multiproyect wafer). Dicha preparación incluye asignación y preparación de puertos, creacion de bancos de pruebas para su fabricación y documentación pertinente. 
\end{itemize}
...
\node (step8) [process, below=0.4cm of dec3] {Envío a Fabricación};
...
La tabla \ref{tab:cronograma} incluye un cronograma de actividades que desglosa seis fases de investigación, comprendidas a lo largo de 2 años  de investigación. Las actividades a realizar en cada fase están descritas a continuación:

\begin{itemize}
    \item \textbf{Fase 1 (Febrero a Julio del 2027):} En esta fase se evaluará en el estado del arte la tecnologías disponibles en el desarrollo de semiconductores, que ofrezcan las capacidades en FEOL (Front end of the Line)  para fabricar nuestros diseños. A su vez, se diseñaran simulaciones numericas en software especializado de codigo abierto para mostrar resultados preeliminares de una estructura de SNN analogica de proposito general. (Entregable: Informe del edo. del arte: un diseño preeliminar en esquemático, simulaciones pre-layout, posibles fabricantes + cotizaciones de fabricación, documento de requerimentos del producto minimo viable)
...
\begin{itemize}
    ...
    \item Participación con grupos de estudiantes de posgrado y pregado en iniciativas de concurso de desarrollo de dispositivos semiconductores (Chipathon).
    \item Dirección de trabajo de tesis de estudiantes de pregrado y posgrado, que sirvan como subcomponentes del proyecto que cubre el objetivo general.
...
\begin{itemize}
    \item Fabricación de dos lotes de semiconductores para inversión (200 mil pesos)
    \item Fabricación de PCBs y circuitería periférica (20 mil pesos)
    \item Gastos generados de la publicación de resultados en artículo JCR 
    \item Taller de diseño y simulación de sistemas VLSI en software libre  (10 mil pesos)
\end{itemize}
...
\begin{itemize}
    \item  Formación de recursos humanos en cómputo analógico, procesamiento de señales y desarrollo VLSI, mediante cursos
 de licenciatura, posgrado y talleres a lo largo del año.
    \item Diseño y fabricación de prototipos de circuitos CMOS para implentación de algoritmos de aprendizaje automático en bajo consumo. 
    \item Desarrollo de aplicaciones: En medicina, transporte, alimentos, problemas nacionales diversos.
    \item Dirección de trabajo de tesis de estudiantes de licenciatura, maestría y doctorado.
    \item Publicación de los resultados teóricos y práctico del proyecto.
    \item Tramitar la protección intelectual de los productos relevantes.
    \end{itemize}
